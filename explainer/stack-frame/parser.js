...
// Dual export: CommonJS (Node) and browser global, so the file works both
// in `node` tests and when loaded via a plain <script> tag (no server needed).
if (typeof module !== "undefined" && module.exports) {
  module.exports = __larkExports;
}
if (typeof window !== "undefined") {
  window.LarkParser = __larkExports;
}
